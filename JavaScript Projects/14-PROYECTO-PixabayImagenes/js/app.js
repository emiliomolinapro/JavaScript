...
function mostrarAlerta(mensaje) {
    const claseAlerta = document.querySelector('.bg-red-100')

    if (!claseAlerta) {
        const alerta = document.createElement('p')
        alerta.classList.add('bg-red-100', 'border', 'border-red-400', 'text-red-700', 'px-4',
...
function buscarImagenes() {
    ...
    const key = '33642086-89a6e76f5f5b7f26a8c9485bc'
